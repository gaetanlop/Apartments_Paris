# Paris Real Estate Price Prediction APP: Project Overview
* **Final Product Hosted On Heroku:** https://house-price-prediction-paris.herokuapp.com/
*   Created a web app that estimates the price of an apartment in Paris in 2020 (MAE ~ € 74 K) to help people finding the best price to sold or buy an apartment.
